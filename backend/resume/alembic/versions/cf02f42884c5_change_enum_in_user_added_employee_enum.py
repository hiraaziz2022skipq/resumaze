"""change enum in user, added employee enum

Revision ID: cf02f42884c5
Revises: aa518620ae5e
Create Date: 2024-08-16 12:30:46.140413
...
revision: str = 'cf02f42884c5'
down_revision: Union[str, None] = 'aa518620ae5e'
